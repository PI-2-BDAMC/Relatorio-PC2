...
As dimensões são mostradas na Figura a seguir:
...
O órgão que delimita os limites legais de emissões veiculares, no Brasil, é o Conselho Nacional do Meio Ambiente (CONAMA). Para a implementação das resoluções, o CONAMA criou o Programa de Controle da Poluição do Ar por Veículos Automotores (PROCONVE) para os veículos leves e pesados, fixando prazos, limites máximos de emissões e estabelecendo exigências tecnológicas para veículos automotores, nacionais e importados. [3]
...
\begin{table}[]
\centering
\caption{Dados técnicos do analisador de gases (NAPRO)[4].}
\label{my-label}
\begin{tabular}{|c|c|}
\hline
ALIMENTAÇÃO        & 12VDC ou 110/110AVC – 60Hz                                                                                    \\ \hline
ESCALAS            & \begin{tabular}[c]{@{}c@{}}CO: 0 - 15\%\\ CO2: 0 - 20\%\\ HC: 0 - 20000ppm Hexano\\ O2: 0 - 25\%\end{tabular} \\ \hline
